...
const en = {
  ...
  // says things a screen does not ("PAYMENT SUCCESSFUL" as a stamp, a filename),
  // and because ✓ is not in the embedded font — the PDF spells statuses out.
  receipt: {
    ...
    // {merchant} is replaced with the merchant's name.
    feeNote: 'The payment link fee is a service charge received by {merchant} together with the invoice amount. HexaBee does not receive funds from the payer.',
    theMerchant: 'the merchant',
    automated: 'This is an automated payment receipt generated by HexaBee.',
    filename: 'hexabee-receipt',
  },
  redirect: {
...
const lt: PayDict = {
  ...
  receipt: {
    ...
    statusPaid: 'MOKĖJIMAS SĖKMINGAS',
    statusLabel: 'Būsena',
    paid: 'Apmokėta',
    amount: 'Suma',
    invoiceAmount: 'Sąskaitos suma',
    ...
    payerEmail: 'Mokėtojo el. paštas',
    payerName: 'Mokėtojas',
    feeNote: 'Apmokėjimo per nuorodą mokestis yra paslaugos mokestis, kurį kartu su sąskaitos suma gauna {merchant}. HexaBee lėšų iš mokėtojo negauna.',
    theMerchant: 'pardavėjas',
    automated: 'Tai automatiškai HexaBee sugeneruotas mokėjimo kvitas.',
    filename: 'hexabee-kvitas',
  },
  redirect: {
